...
"""
        robot.commands.eyering.stage_eyering((False, True, False, False, False, False, False, False, False, False, False, True), 0.4)
        ...
        robot.cmds.media.do_audio(WWMedia.WWSound.WWSoundDash.CUSTOM_05)
